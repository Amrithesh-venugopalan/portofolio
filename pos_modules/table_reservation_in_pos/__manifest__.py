...
################################################################################
{
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'table_reservation_in_pos/static/src/xml/EditBar.xml',
            'table_reservation_in_pos/static/src/js/EditBar.js',
            'table_reservation_in_pos/static/src/scss/style.scss',
        ],
    },
    'installable': True,
    'auto_install': False,
